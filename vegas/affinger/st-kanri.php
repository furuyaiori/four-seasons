...
$stdata270 = get_option( 'st-data270', 'yes' );
...
$stdata386 = get_option( 'st-data386', 'yes' );
...
$stdata635 = get_option( 'st-data635', '' );
$stdata636 = get_option( 'st-data636', '' );
$stdata637 = get_option( 'st-data637', '' );
$stdata638 = get_option( 'st-data638', '' );
$stdata639 = get_option( 'st-data639', '' );
$stdata640 = get_option( 'st-data640', '' );
$stdata641 = get_option( 'st-data641', '' );
$stdata642 = get_option( 'st-data642', '' );
$stdata643 = get_option( 'st-data643', '' );
$stdata644 = get_option( 'st-data644', 'yes' );
