...
if ( !function_exists( 'st_kaiwasc1_func' ) ) {
	function st_kaiwasc1_func( $arg, $content = null ) {
		...
		if( isset($arg[0]) && ($arg[0] === 'r') ){
			return '<div class="st-kaiwa-box kaiwaicon1 clearfix"><div class="st-kaiwa-area2"><div class="st-kaiwa-hukidashi2">'.$content.'</div></div><div class="st-kaiwa-face2"><img src="'.$kaiwaiconurl.'" width="60px" alt=""><div class="st-kaiwa-face-name2">'.$kaiwaiconname.'</div></div></div>';
		} else {
			return '<div class="st-kaiwa-box kaiwaicon1 clearfix"><div class="st-kaiwa-face"><img src="'.$kaiwaiconurl.'" width="60px" alt=""><div class="st-kaiwa-face-name">'.$kaiwaiconname.'</div></div><div class="st-kaiwa-area"><div class="st-kaiwa-hukidashi">'.$content.'</div></div></div>';
		}
...
if ( !function_exists( 'st_kaiwasc2_func' ) ) {
	function st_kaiwasc2_func( $arg, $content = null ) {
		...
		if( isset($arg[0]) && ($arg[0] === 'r') ){
			return '<div class="st-kaiwa-box kaiwaicon2 clearfix"><div class="st-kaiwa-area2"><div class="st-kaiwa-hukidashi2">'.$content.'</div></div><div class="st-kaiwa-face2"><img src="'.$kaiwaiconurl.'" width="60px" alt=""><div class="st-kaiwa-face-name2">'.$kaiwaiconname.'</div></div></div>';
		} else {
			return '<div class="st-kaiwa-box kaiwaicon2 clearfix"><div class="st-kaiwa-face"><img src="'.$kaiwaiconurl.'" width="60px" alt=""><div class="st-kaiwa-face-name">'.$kaiwaiconname.'</div></div><div class="st-kaiwa-area"><div class="st-kaiwa-hukidashi">'.$content.'</div></div></div>';
		}
...
if ( !function_exists( 'st_kaiwasc3_func' ) ) {
	function st_kaiwasc3_func( $arg, $content = null ) {
		...
		if( isset($arg[0]) && ($arg[0] === 'r') ){
			return '<div class="st-kaiwa-box kaiwaicon3 clearfix"><div class="st-kaiwa-area2"><div class="st-kaiwa-hukidashi2">'.$content.'</div></div><div class="st-kaiwa-face2"><img src="'.$kaiwaiconurl.'" width="60px" alt=""><div class="st-kaiwa-face-name2">'.$kaiwaiconname.'</div></div></div>';
		} else {
			return '<div class="st-kaiwa-box kaiwaicon3 clearfix"><div class="st-kaiwa-face"><img src="'.$kaiwaiconurl.'" width="60px" alt=""><div class="st-kaiwa-face-name">'.$kaiwaiconname.'</div></div><div class="st-kaiwa-area"><div class="st-kaiwa-hukidashi">'.$content.'</div></div></div>';
		}
...
if ( !function_exists( 'st_kaiwasc4_func' ) ) {
	function st_kaiwasc4_func( $arg, $content = null ) {
		...
		if( isset($arg[0]) && ($arg[0] === 'r') ){
			return '<div class="st-kaiwa-box kaiwaicon4 clearfix"><div class="st-kaiwa-area2"><div class="st-kaiwa-hukidashi2">'.$content.'</div></div><div class="st-kaiwa-face2"><img src="'.$kaiwaiconurl.'" width="60px" alt=""><div class="st-kaiwa-face-name2">'.$kaiwaiconname.'</div></div></div>';
		} else {
			return '<div class="st-kaiwa-box kaiwaicon4 clearfix"><div class="st-kaiwa-face"><img src="'.$kaiwaiconurl.'" width="60px" alt=""><div class="st-kaiwa-face-name">'.$kaiwaiconname.'</div></div><div class="st-kaiwa-area"><div class="st-kaiwa-hukidashi">'.$content.'</div></div></div>';
		}
...
if ( !function_exists( 'st_kaiwasc5_func' ) ) {
	function st_kaiwasc5_func( $arg, $content = null ) {
		...
		if( isset($arg[0]) && ($arg[0] === 'r') ){
			return '<div class="st-kaiwa-box kaiwaicon5 clearfix"><div class="st-kaiwa-area2"><div class="st-kaiwa-hukidashi2">'.$content.'</div></div><div class="st-kaiwa-face2"><img src="'.$kaiwaiconurl.'" width="60px" alt=""><div class="st-kaiwa-face-name2">'.$kaiwaiconname.'</div></div></div>';
		} else {
			return '<div class="st-kaiwa-box kaiwaicon5 clearfix"><div class="st-kaiwa-face"><img src="'.$kaiwaiconurl.'" width="60px" alt=""><div class="st-kaiwa-face-name">'.$kaiwaiconname.'</div></div><div class="st-kaiwa-area"><div class="st-kaiwa-hukidashi">'.$content.'</div></div></div>';
		}
...
if ( !function_exists( 'st_kaiwasc6_func' ) ) {
	function st_kaiwasc6_func( $arg, $content = null ) {
		...
		if( isset($arg[0]) && ($arg[0] === 'r') ){
			return '<div class="st-kaiwa-box kaiwaicon6 clearfix"><div class="st-kaiwa-area2"><div class="st-kaiwa-hukidashi2">'.$content.'</div></div><div class="st-kaiwa-face2"><img src="'.$kaiwaiconurl.'" width="60px" alt=""><div class="st-kaiwa-face-name2">'.$kaiwaiconname.'</div></div></div>';
		} else {
			return '<div class="st-kaiwa-box kaiwaicon6 clearfix"><div class="st-kaiwa-face"><img src="'.$kaiwaiconurl.'" width="60px" alt=""><div class="st-kaiwa-face-name">'.$kaiwaiconname.'</div></div><div class="st-kaiwa-area"><div class="st-kaiwa-hukidashi">'.$content.'</div></div></div>';
		}
...
if ( !function_exists( 'st_kaiwasc7_func' ) ) {
	function st_kaiwasc7_func( $arg, $content = null ) {
		...
		if( isset($arg[0]) && ($arg[0] === 'r') ){
			return '<div class="st-kaiwa-box kaiwaicon7 clearfix"><div class="st-kaiwa-area2"><div class="st-kaiwa-hukidashi2">'.$content.'</div></div><div class="st-kaiwa-face2"><img src="'.$kaiwaiconurl.'" width="60px" alt=""><div class="st-kaiwa-face-name2">'.$kaiwaiconname.'</div></div></div>';
		} else {
			return '<div class="st-kaiwa-box kaiwaicon7 clearfix"><div class="st-kaiwa-face"><img src="'.$kaiwaiconurl.'" width="60px" alt=""><div class="st-kaiwa-face-name">'.$kaiwaiconname.'</div></div><div class="st-kaiwa-area"><div class="st-kaiwa-hukidashi">'.$content.'</div></div></div>';
		}
...
if ( !function_exists( 'st_kaiwasc8_func' ) ) {
	function st_kaiwasc8_func( $arg, $content = null ) {
		...
		if( isset($arg[0]) && ($arg[0] === 'r') ){
			return '<div class="st-kaiwa-box kaiwaicon8 clearfix"><div class="st-kaiwa-area2"><div class="st-kaiwa-hukidashi2">'.$content.'</div></div><div class="st-kaiwa-face2"><img src="'.$kaiwaiconurl.'" width="60px" alt=""><div class="st-kaiwa-face-name2">'.$kaiwaiconname.'</div></div></div>';
		} else {
			return '<div class="st-kaiwa-box kaiwaicon8 clearfix"><div class="st-kaiwa-face"><img src="'.$kaiwaiconurl.'" width="60px" alt=""><div class="st-kaiwa-face-name">'.$kaiwaiconname.'</div></div><div class="st-kaiwa-area"><div class="st-kaiwa-hukidashi">'.$content.'</div></div></div>';
		}
...
ショートコード対応処理(記事リンク表示)
----------------------------------*/
function PostLink($params = array())
{
		extract(shortcode_atts(array('url' => 'default', 'text' => ''), $params));
	$title = get_the_title(url_to_postid($url));
	$link =(get_the_permalink(url_to_postid($url)));
...
<div class="reference_link_wrap">
        ...
        <div class="list-links ">
            <a href="<?php echo $link?>" rel="noopener noreferrer"><?php echo $title;?></a>
        </div>
    </div>
<?php
	return ob_get_clean();
}
add_shortcode('post_link', 'PostLink');

/*----------------------------------
ショートコード対応処理(記事リンク表示)
----------------------------------*/
function CatLink($params = array())
{
		extract(shortcode_atts(array('id' => 'default', 'text' => ''), $params));
	$title = (get_option('cat_'.$id)['st_cattitle']);
...
add_shortcode('cat_link', 'CatLink');


/*----------------------------------
ショートコード対応処理(記事リンク表示)
----------------------------------*/
function NaibuLink($params = array())
{
	extract(shortcode_atts(array('id' => 'default', 'text' => 'この記事の関連記事まとめ'), $params));
	$array = explode(",", $id);
	ob_start();
	?>

	<div class="cachnavi_box">
		<div class="cachnavi_head"><img src="https://vegas-online.jp/wp-content/uploads/2020/07/menuheadicon_03.png" class="navimg0001"><?php echo $text ?></div>
		<div class="cachnavi_main">
			<ul>
				<?php foreach ($array as $item):
					...
					<li><div class="cachnav_ico"><i class="fa fa-hand-o-right" aria-hidden="true"></i></div>
						<div class="cachnavi_list"><a href="<?php echo $link; ?>"><?php echo $title;?></a></div></li>
						<?php
					endforeach;
					?>
				</ul>
...
add_shortcode('naibu_link', 'NaibuLink');


function StepDescription($params = array())
{
		extract(shortcode_atts(array('id' => 'default'), $params));

	ob_start();
		?>

<?php while ( have_rows('step_group') ) : the_row(); ?>
      <?php if($id == get_sub_field("step_num")): ?>
    <article class="casino-page-content-entry">
      <ul class="step">
        <?php while ( have_rows('step_info') ) : the_row(); ?>
          <li class="step-item">
            <div class="step-num"><?php the_sub_field('title_area'); ?></div>
            <div class="step-content">
              <div class="step-image">
              <img src='<?php echo get_sub_field('image_area')["url"]?>' alt="">
              </div>
              <div class="step-text">
                <?php the_sub_field('article_area'); ?>
              </div>
            </div>
          </li>
        <?php endwhile; ?>
...
add_shortcode('step_description', 'StepDescription');
add_filter('category_description', 'do_shortcode');


function H2Recommended($params = array())
{
	extract(shortcode_atts(array('id' => 'default', 'text' => ''), $params));
	ob_start();
	?>
	<div class="recommend-box">
		<div class="recommend-title"><?php echo $text;?></div>
		<div class="recommend-icon">
			<img src="https://vegas-online.jp/wp-content/uploads/2023/10/bnr.png">
		</div>
	</div>
	<?php
	return ob_get_clean();
}
add_shortcode('h2_recommended', 'H2Recommended');
...
function adsense_before_h2($the_content) {
  if (is_single()) {
    $cv_html = '<a href="/st-manager/click/track?id='.get_the_ID().'&type=raw&url=https://vegas-online.jp/diagnosis/&source_url='.get_the_permalink(get_the_ID()).'&source_title='.get_the_title(get_the_ID()).'"><img decoding="async" src="https://vegas-online.jp/wp-content/uploads/2024/01/shindan_cta02.webp" alt="診断コンテンツ" width="530" height="345" class="aligncenter wp-image-27433 size-full" srcset="https://vegas-online.jp/wp-content/uploads/2024/01/shindan_cta02.webp 530w, https://vegas-online.jp/wp-content/uploads/2024/01/shindan_cta02-300x195.webp 300w" sizes="(max-width: 530px) 100vw, 530px"></a>';
    
    preg_match_all( '/<h2(.*?)<\/h2>/is', $the_content, $h2s);
    if ( $h2s[0] ) {
      if ( $h2s[0][0] ) {
        $the_content  = str_replace($h2s[0][0], $cv_html . $h2s[0][0], $the_content);
      }
    }
    return $the_content;
  }else{
