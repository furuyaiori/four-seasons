...
function replace_media($base_url) {
  if (!strpos($base_url, 'media')) {
    return '/media' . $base_url;
  }
  return $base_url;
}
?>
...
<div class="pagination"><?php global $wp_rewrite;
  ...
  echo paginate_links(array(
    'base' => replace_media($paginate_base),
