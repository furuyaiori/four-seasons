...
if (is_front_page()) {
    ...
    echo '<a href="https://four-seasons.jp" itemprop="item">';
    echo '<span itemprop="name" class="breadcrumb-caption">ホーム</span>';
    echo '</a>';
    echo '<meta itemprop="position" content="1" />';
    echo '<span class="sp">/</span>';
	echo '<a href="' . esc_url(get_home_url()) . '" itemprop="item">';
    echo '<span itemprop="name" class="breadcrumb-caption">コラム</span>';
    echo '</a>';
    echo '</div>';
}
